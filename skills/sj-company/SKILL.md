...
**마케팅 감지 키워드:**
마케팅, SNS, 캠페인, 카피, 게시글, 포스팅, 홍보, 인스타, 인스타그램, 스레드, threads, 링크드인, linkedin, 트위터, 광고 문구, 콘텐츠 작성, 컨텐츠, 카드뉴스, 슬라이드 포스팅, sns-start, 브랜드 카피, 마케팅 글

→ 감지 시:
```
[마케팅] SNS 마케팅 요청을 감지했습니다. sj-marketing을 실행합니다.
```
