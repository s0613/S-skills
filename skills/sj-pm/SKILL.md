...
> **컨벤션:** [옵시디언 지식 참조](../_conventions/obsidian-context.md) — 요구사항 분석 전 볼트의 `10_지식/02_기획`·`40_프로젝트`에서 관련 문서 1~3개를 확인하고, 참조했으면 pm-brief에 `[OBSIDIAN: 경로]`로 기록한다. 볼트 없으면 `미수행:` 한 줄 남기고 비차단 진행.
